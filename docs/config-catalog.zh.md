...
export interface Config {
  ...
  /** Parent directory for new Sessions without a Workspace or cwd; relative paths start at the Host home. */
  readonly noProjectDirectory?: string
}
```
...
来源：[`packages/llm/token-meter/src/types.ts:19`](../packages/llm/token-meter/src/types.ts)
...
- `@deepseek-ai/dsh-client-ui-desktop-shell` — requires `appReady` ([`packages/client/ui-desktop-shell/src/index.ts`](../packages/client/ui-desktop-shell/src/index.ts))
