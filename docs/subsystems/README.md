...
| [desktop-control.md](desktop-control.md) | the closed browser/computer control protocol, immutable bounded Host service seams, opaque ownership references, and fail-closed native policy |
