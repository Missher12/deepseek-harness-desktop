...
Documents retain separate immutable content addresses for their source bytes and bounded extracted text. Renderer projections expose sanitized name, format and size only; storage identifiers, extracted content and host paths stay on the Host.
