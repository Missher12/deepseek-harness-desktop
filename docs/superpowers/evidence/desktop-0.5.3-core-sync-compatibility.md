...
Links for relocated files target the historical Task 2 Desktop commit above. They preserve the inspected inventory rather than claiming that those files still occupy the current checkout paths.
