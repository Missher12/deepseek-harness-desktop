...
- [ ] **Step 1: Write a failing shared-page test**
...
- [ ] **Step 3: Make the polished document platform-neutral**
...
- [ ] **Step 1: Write failing Windows Desktop boot assertions**
...
- [ ] **Step 3: Generalize the explicit Desktop marker**
...
- [ ] **Step 4: Run focused Web/Desktop tests and verify GREEN**
...
- [ ] **Step 5: Commit the independently testable loading change**
...
- [ ] **Step 2: Build production Host, Client, Web, and Desktop main**
...
- [ ] **Step 3: Record the current implementation boundary**
