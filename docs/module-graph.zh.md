...
flowchart TD
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_desktop_control["client-ui-desktop-control"]
  ...
  subgraph group_control["packages/control"]
    ...
    pkg_tool_browser_control["tool-browser-control"]
    pkg_tool_computer_control["tool-computer-control"]
  end
  ...
  pkg_tool_browser_control --> pkg_agent
  pkg_tool_browser_control --> pkg_attachment
  pkg_tool_browser_control --> pkg_browser_control
  pkg_tool_browser_control --> pkg_desktop_control_protocol
  pkg_tool_browser_control --> pkg_invariants
  pkg_tool_browser_control --> pkg_llm
  pkg_tool_browser_control --> pkg_session
  pkg_tool_browser_control --> pkg_system_prompt
  pkg_tool_browser_control --> pkg_tools
  pkg_tool_computer_control --> pkg_agent
  pkg_tool_computer_control --> pkg_attachment
  pkg_tool_computer_control --> pkg_computer_control
  pkg_tool_computer_control --> pkg_desktop_control_protocol
  pkg_tool_computer_control --> pkg_invariants
  pkg_tool_computer_control --> pkg_llm
  pkg_tool_computer_control --> pkg_session
  pkg_tool_computer_control --> pkg_tools
...
| [`client-ui-desktop-control`](../packages/client/ui-desktop-control) | `client` | — |
...
| [`client-ui-settings-brain`](../packages/client/ui-settings-brain) | `client` | — |
...
| [`client-ui-settings-personalization`](../packages/client/ui-settings-personalization) | `client` | — |
...
| [`client-ui-settings-system-update`](../packages/client/ui-settings-system-update) | `client` | — |
...
| [`desktop-workbench`](../packages/extensions/desktop-workbench) | `extensions` | — |
| [`reasoning-effort`](../packages/extensions/reasoning-effort) | `extensions` | — |
| [`session-messenger`](../packages/extensions/session-messenger) | `extensions` | — |
...
| [`tool-browser-control`](../packages/control/tool-browser-control) | `control` | [`agent`](../packages/core/agent), [`attachment`](../packages/attachment/attachment), [`browser-control`](../packages/control/browser-control), [`desktop-control-protocol`](../packages/control/desktop-control-protocol), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
| [`tool-computer-control`](../packages/control/tool-computer-control) | `control` | [`agent`](../packages/core/agent), [`attachment`](../packages/attachment/attachment), [`computer-control`](../packages/control/computer-control), [`desktop-control-protocol`](../packages/control/desktop-control-protocol), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`tools`](../packages/core/tools) |
...
| [`api-settings-controller`](../packages/api/settings-controller) | `api` | [`agent-presets`](../packages/preset/agent-presets), [`credentials`](../packages/credentials/credentials), [`home-paths`](../packages/util/home-paths), [`invariants`](../packages/runtime-diagnostics/invariants), [`native-command`](../packages/util/native-command), [`session`](../packages/core/session), [`settings`](../packages/settings/settings), [`typert-protocol`](../packages/typert/protocol) |
