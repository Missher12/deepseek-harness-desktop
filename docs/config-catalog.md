...
Requires: `settings` · `credentials` · `storageDomain` · `apiProxy` · `attachments` · `workspaceRegistry` · `typert` · `agents` · `webServer`
...
Source: [`packages/extensions/lark/src/config.ts:14`](../packages/extensions/lark/src/config.ts)
