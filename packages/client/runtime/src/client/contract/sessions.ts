...
import type {
  RpcResult, SessionForkPosition, SessionId, SubagentAddress,
...
export interface ISessions {
  ...
  /**
   * Fork a session through a completed turn, or immediately before an exact
   * completed turn-opening user message; on resolution the child is in the
