...
export const zh = {
  ...
  'stats.lastTurnCost': '本轮估算 {cost}',
  'stats.cost': '会话估算 {cost}',
  'stats.balance': '可用余额 {balance}',
  'stats.balanceUnavailable': '余额暂不可用',
  'stats.tier.weekday-peak': '工作日高峰',
  'stats.tier.weekday-off-peak': '工作日低谷',
  'stats.tier.weekend-off-peak': '周末低谷',
  'details.title': '详情',
  'details.close': '关闭详情',
  ...
  'message.relay.unknownSender': '未知会话',
  'message.relay.from': '来自 {sender}',
...
export const en = {
  ...
  'promptRail.imageOnly': 'Image prompt',
  'promptRail.unavailable': 'That prompt is not available in the loaded history',
  ...
  'message.relay.unknownSender': 'unknown session',
  'message.relay.from': 'From {sender}',
  'message.relay.wake': 'Woke session',
