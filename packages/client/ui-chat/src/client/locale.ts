...
export const zh = {
  ...
  'stats.lineCounts': '{turns} 轮 · {steps} 步',
  ...
  'message.relay.from': '由 {session} 从另一个聊天发来',
  ...
  'message.think': '思考',
  'message.reasoning.content': '思考内容',
  'message.reasoning.expand': '展开思考',
  'message.reasoning.collapse': '收起思考',
  'message.reasoning.pause': '暂停跟随',
  'message.reasoning.follow': '跟随最新',
  'message.reasoning.original': '原始思考 · 可滚动阅读',
...
export const en = {
  ...
  'stats.lineCounts': '{turns} turns · {steps} steps',
  'stats.llm': 'LLM {duration}',
  ...
  'message.relay.from': 'Sent from another chat by {session}',
  ...
  'message.compaction.commandTitle': 'compact',
  'message.think': 'Think',
  'message.reasoning.content': 'Reasoning content',
  'message.reasoning.expand': 'Expand reasoning',
  'message.reasoning.collapse': 'Collapse reasoning',
  'message.reasoning.pause': 'Pause following',
  'message.reasoning.follow': 'Follow latest',
  'message.reasoning.original': 'Original reasoning · scroll to read',
