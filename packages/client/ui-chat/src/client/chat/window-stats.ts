/** Shared statistics and localized durations for conversation summary views. */
...
/** Counts and timings for the loaded conversation window. */
 ...
 * @param t - the owning conversation locale.
