...
export function ChatView({
  ...
  onScrollRef.current = () => {
    ...
    // Upward movement retains reader ownership even when a resize preceded sampling.
    // Only unrequested forward drift can be browser anchoring of a pinned view.
    const anchoredLayoutShift = movedByReader
      && layoutShiftPendingRef.current
      && atBottomRef.current
      && el.scrollTop >= observedTopRef.current
