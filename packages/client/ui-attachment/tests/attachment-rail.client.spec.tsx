...
import { DocumentChip } from '../src/DocumentChip.tsx'
...
describe('AttachmentRail', () => {
  ...
  it('renders a document without a supplied type label using an empty visual label', () => {
    ...
    const view = render(<AttachmentRail items={[document]} labels={labels} renderItem={() => <DocumentChip name="README" typeLabel="" />} />)
