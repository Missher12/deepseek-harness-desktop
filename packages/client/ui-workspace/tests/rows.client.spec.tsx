...
import { ProjectRowItem, SearchResultItem, SessionNodeItem as SessionNodeItemImpl } from '../src/client/rows/Rows.tsx'
...
type SessionNodeItemTestProps = Omit<ComponentProps<typeof SessionNodeItemImpl>, 'onCopyId'> & {
  onCopyId?: ComponentProps<typeof SessionNodeItemImpl>['onCopyId']
}

/** Most row fixtures do not exercise the copy action; keep that required production seam explicit at the test boundary. */
function SessionNodeItem({ onCopyId = vi.fn(), ...props }: SessionNodeItemTestProps) {
  return <SessionNodeItemImpl {...props} onCopyId={onCopyId} />
}
