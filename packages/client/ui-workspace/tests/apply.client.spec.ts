...
async function bench() {
  ...
  return {
    ...
    insertSessionBefore, archiveSession, restoreSession, deleteSession,
    open, clear, search, renameSession, binding, fork, pickDirectory,
  }
}
...
describe('ui-workspace apply', () => {
  ...
  it('routes browser actions and picker creation to the services', async () => {
    ...
    await browser.restoreSession('session' as never)
    expect(b.restoreSession).toHaveBeenCalledWith('session')
