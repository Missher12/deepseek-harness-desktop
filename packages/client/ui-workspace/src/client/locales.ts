...
export const zh = {
  ...
  'menu.noProject': '不在项目中',
  'session.newFailed': '无法新建会话：{reason}',
  ...
  'copy.sessionIdSuccess': '会话 ID 已复制',
  'copy.sessionIdFailed': '无法复制会话 ID',
  'archive.open': '归档',
  'archive.title': '已归档会话',
  'archive.empty': '暂无已归档会话',
  'archive.restore': '恢复',
  'archive.restorePending': '正在恢复会话…',
  'archive.delete': '删除',
  'archive.delete.confirm': '永久删除',
  'archive.delete.title': '永久删除会话',
  'archive.delete.desc': '将永久删除“{name}”的会话记录，且无法恢复。工作区文件、全局设置和凭据不会被删除。',
  'archive.delete.pending': '正在永久删除会话…',
...
export const en = {
  ...
  'session.newFailed': 'Couldn’t start a new session: {reason}',
  ...
  'copy.sessionIdSuccess': 'Session ID copied',
  'copy.sessionIdFailed': 'Couldn’t copy session ID',
  'archive.open': 'Archive',
  'archive.title': 'Archived sessions',
  'archive.empty': 'No archived sessions',
  'archive.restore': 'Restore',
  'archive.restorePending': 'Restoring session…',
  'archive.delete': 'Delete',
  'archive.delete.confirm': 'Delete permanently',
  'archive.delete.title': 'Permanently delete session',
  'archive.delete.desc': 'This permanently deletes the session history for “{name}” and cannot be undone. Workspace files, global settings, and credentials are not deleted.',
  'archive.delete.pending': 'Permanently deleting session…',
