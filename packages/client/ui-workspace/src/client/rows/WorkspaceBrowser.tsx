...
> & {
  ...
  /** Copy a session's exact identifier from its row menu. */
  onSessionCopyId: (sessionId: SessionNode['id']) => void
...
function SessionTree({
  ...
  onRenameRequest, onDeleteRequest, onSessionRename, onSessionArchive, onSessionCopyId,
...
function FlatList({
  ...
  onSessionCopyId, archivedSessionIds,
...
export function WorkspaceBrowser({
  ...
  // Archived-session manager. Archive is reversible; permanent deletion is
  // deliberately reachable only from this surface and owns confirmation.
