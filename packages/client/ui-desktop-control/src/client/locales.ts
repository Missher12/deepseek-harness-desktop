export const en = {
  ...
  browserControl: 'Browser control', computerControl: 'Computer control', screenViewing: 'Screen Viewing',
...
export const zh: DesktopControlLabels = {
  ...
  browserControl: '浏览器控制', computerControl: '电脑控制', screenViewing: '屏幕查看',
