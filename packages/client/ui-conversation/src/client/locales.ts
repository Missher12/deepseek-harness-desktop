...
export const zh = {
  ...
  'attachment.dropDesc': '图片最多 {imageCount} 张（{imageSize}/张）；文档最多 {documentCount} 个（{documentSize}/个）',
...
export const en = {
  ...
  'attachment.dropDesc': 'Up to {imageCount} images ({imageSize} each) and {documentCount} documents ({documentSize} each)',
