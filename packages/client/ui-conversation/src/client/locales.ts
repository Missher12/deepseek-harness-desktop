...
export const zh = {
  ...
  'message.relay.title': '跨会话消息',
  'message.relay.from': '来自',
  'message.relay.mode.inject': '静默发送',
  'message.relay.mode.followup': '唤醒发送',
  'message.relay.copySessionId': '复制来源会话 ID',
  'message.relay.reply': '回复',
  'message.relay.details': '传递详情',
...
export const en = {
  ...
  'message.relay.title': 'Cross-session message',
  'message.relay.from': 'From',
  'message.relay.mode.inject': 'Quiet delivery',
  'message.relay.mode.followup': 'Wake delivery',
  'message.relay.copySessionId': 'Copy source session ID',
  'message.relay.reply': 'Reply',
  'message.relay.details': 'Delivery details',
