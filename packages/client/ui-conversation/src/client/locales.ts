...
export const zh = {
  ...
  'message.editFrom': '编辑并从这里继续',
  'message.editUnavailable': '仅可从已完成轮次的起始消息继续',
  'message.editFailed': '无法从这里继续：{message}',
...
export const en = {
  ...
  'message.editFrom': 'Edit and continue from here',
  'message.editUnavailable': 'Available only on the opening message of a completed turn',
  'message.editFailed': 'Could not continue from here: {message}',
