...
export const zh = {
  ...
  'input.add': '添加',
  'add.files': '文件和文件夹',
  'add.filesDescription': '引用工作区中的文件、文件夹或会话',
  'add.image': '添加附件',
  'add.imageDescription': '图片、PDF、Word、Excel、文本或代码',
  'add.section': '添加',
  'add.commandsSection': '命令',
  'add.pluginsSection': '插件',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter 插话发送全部排队消息',
  'input.accessMode': '访问模式，当前：{name}',
  'attachment.dropTitle': '把图片或文件拖到此处',
  'attachment.dropDesc': '图片最多 {imageCount} 张（{imageSize}/张）；文件最多 {documentCount} 个（{documentSize}/个）',
  ...
  'attachment.totalTooLarge': '图片与文件编码后合计超过 {size}，请移除部分附件',
  ...
  'document.unsupportedType': '仅支持 PDF、DOCX、XLSX、文本和常见代码文件',
  'document.tooMany': '一条消息最多添加 {count} 个文件',
  'document.fileTooLarge': '单个文件不能超过 {size}',
  'document.totalTooLarge': '文件总大小超过 {size}，请移除部分文件',
  'document.nameTooLong': '文件名过长，请缩短后重试',
  'document.invalid': '文件内容与格式不匹配或无法读取',
  'document.encrypted': '暂不支持加密文档，请解密后重试',
  'document.macrosUnsupported': '暂不支持带宏的 Office 文档',
  'document.sendFailed': '文件发送失败（{reason}），请重新添加后再试',
  ...
  'stats.lastTurnCost': '本轮约 ¥{cost}',
  'stats.cost': '会话约 ¥{cost}',
  'stats.balance': '可用余额 {balance}',
  'stats.balanceUnavailable': '余额暂不可用',
  'stats.tier.weekday-peak': '工作日高峰价',
  'stats.tier.weekday-off-peak': '工作日低谷价',
  'stats.tier.weekend-off-peak': '周末低谷价',
  ...
  'settings.desktop.close.title': '关闭窗口时',
  'settings.desktop.close.description': '保留运行后可从 Dock 或 Windows 托盘重新打开',
  'settings.desktop.close.keepRunning': '保留运行',
  'settings.desktop.close.quit': '退出应用',
  'settings.desktop.pricing.title': '峰谷价格估算',
  'settings.desktop.pricing.description': '显示本轮、会话估算费用和当前价格时段；余额仍会保留',
  ...
  'chat.loadOlder': '加载更早',
  'chat.toBottom': '回到底部',
  'promptRail.aria': '过往发言',
  'promptRail.jump': '转到第 {index} 条发言：{preview}',
  'promptRail.tooltip': '第 {index} 条发言 · {time}',
  'promptRail.count': '{current} / {total}',
  'promptRail.compact': '发言导航（{current} / {total}）',
  'promptRail.compactDialog': '发言导航',
  'promptRail.item': '第 {index} 条发言',
  'promptRail.index': '第 {index} 条发言',
  'promptRail.imageOnly': '图片消息',
  'promptRail.unavailable': '这条历史发言暂时无法定位',
  ...
  'message.relay.from': '由 {sender} 从另一个聊天发来',
  'message.relay.wake': '已唤醒',
  'message.relay.unknownSender': '另一个会话',
  ...
  'command.done': '已完成',
  'command.title': '命令',
  'command.imagesUnsupported': '/{command} 不接受附件，请先移除附件',
  'approval.waiting': '等待审批',
  'approval.detail.aria': '审批详情',
  'approval.escalation': '工具 {toolName} 请求越权执行',
  'approval.reject': '拒绝',
  'approval.allowOnce': '允许一次',
  'approval.allowSession': '本会话不再询问',
  'approval.retryCurrent': '重试当前审批',
  'approval.fullAccessFailed': '无法启用 Full access，请重试',
  'approval.responseFailed': '审批响应未送达，请重试',
  'approval.retryAfterFullAccess': 'Full access 已启用，请重试当前审批',
  'ask.rowTitle': '提问',
  'ask.waiting': '等待回答',
  'ask.cancelled': '已取消',
  'ask.interrupted': '已中断',
...
export const en = {
  ...
  'add.filesDescription': 'Reference workspace files, folders, or sessions',
  'add.image': 'Attach file',
  'add.imageDescription': 'Images, PDF, Word, Excel, text, or code',
  'add.section': 'Add',
  'add.commandsSection': 'Commands',
  'add.pluginsSection': 'Plugins',
  'input.stop': 'Stop generating',
  'input.send': 'Send message',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter steers all queued messages',
  'input.accessMode': 'Access mode, current: {name}',
  'attachment.dropTitle': 'Drop images or files here',
  'attachment.dropDesc': 'Up to {imageCount} images ({imageSize} each) and {documentCount} files ({documentSize} each)',
  ...
  'attachment.totalTooLarge': 'Images and files exceed {size} after encoding; remove some attachments and try again',
  ...
  'document.unsupportedType': 'Only PDF, DOCX, XLSX, text, and common code files are supported',
  'document.tooMany': 'A message can include up to {count} files',
  'document.fileTooLarge': 'Each file must be smaller than {size}',
  'document.totalTooLarge': 'Files exceed {size} in total; remove some and try again',
  'document.nameTooLong': 'The file name is too long; shorten it and try again',
  'document.invalid': 'The file contents do not match the format or cannot be read',
  'document.encrypted': 'Encrypted documents are not supported yet; decrypt the file and try again',
  'document.macrosUnsupported': 'Macro-enabled Office documents are not supported yet',
  'document.sendFailed': 'Sending the file failed ({reason}); re-add it and try again',
  ...
  'stats.lastTurnCost': 'Turn est. ¥{cost}',
  'stats.cost': 'Session est. ¥{cost}',
  'stats.balance': 'Available {balance}',
  'stats.balanceUnavailable': 'Balance unavailable',
  'stats.tier.weekday-peak': 'Weekday peak',
  'stats.tier.weekday-off-peak': 'Weekday off-peak',
  'stats.tier.weekend-off-peak': 'Weekend off-peak',
  ...
  'settings.desktop.close.title': 'When closing the window',
  'settings.desktop.close.description': 'Keep running to reopen from the Dock or Windows tray',
  'settings.desktop.close.keepRunning': 'Keep running',
  'settings.desktop.close.quit': 'Quit app',
  'settings.desktop.pricing.title': 'Tiered price estimates',
  'settings.desktop.pricing.description': 'Show turn/session estimates and the current tier; balance remains visible',
  ...
  'promptRail.aria': 'Previous prompts',
  'promptRail.jump': 'Go to prompt {index}: {preview}',
  'promptRail.tooltip': 'Prompt {index} · {time}',
  'promptRail.count': '{current} / {total}',
  'promptRail.compact': 'Prompt navigation ({current} / {total})',
  'promptRail.compactDialog': 'Prompt navigation',
  'promptRail.item': 'Prompt {index}',
  'promptRail.index': 'Prompt {index}',
  'promptRail.imageOnly': 'Image message',
  'promptRail.unavailable': 'This historical prompt is temporarily unavailable',
  ...
  'message.relay.from': 'Sent by {sender} from another chat',
  'message.relay.wake': 'woke this session',
  'message.relay.unknownSender': 'another session',
  ...
  'approval.allowSession': "Don't ask again this session",
  'approval.retryCurrent': 'Retry current approval',
  'approval.fullAccessFailed': 'Could not enable Full access. Try again.',
  'approval.responseFailed': 'The approval response was not delivered. Try again.',
  'approval.retryAfterFullAccess': 'Full access is enabled. Retry the current approval.',
