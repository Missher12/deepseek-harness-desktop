...
import {
  composerAddLauncherSources, createComposerAddSource, type ComposerAddSource,
} from './input/composer-add-source.ts'
...
interface ComposerAddRegistry {
  registerSource(source: ComposerAddSource): () => void
}
...
export function apply(ctx: Context): void {
  ...
  ctx.inject(['inputTriggers'], (scope: Context) => {
    const inputTriggers = scope.get('inputTriggers') as ComposerAddRegistry | undefined
