...
export const en = {
  ...
  modelPresetHint: 'Known model IDs fill missing defaults when you leave the field. Your edits are kept; adjust limits for your provider.',
  ...
  modelReasoningCeiling: 'Reasoning capability',
  modelReasoningAutomatic: 'Automatic (catalog capability)',
  modelReasoningDisabled: 'Not supported',
  modelReasoningOnlyHigh: 'High only',
  modelReasoningLevelXHigh: 'XHigh',
  modelInputCapability: 'Input capability',
  modelInputAutomatic: 'Automatic (catalog or provider default)',
  modelInputText: 'Text only',
  modelInputImages: 'Text and images',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelPresetHint: '输入已知模型 ID 后，离开输入框会补全默认参数。保留手动修改，请按服务商实际限制调整。',
  ...
  modelReasoningCeiling: '推理能力',
  modelReasoningAutomatic: '自动（使用模型目录能力）',
  modelReasoningDisabled: '不支持推理调节',
  modelReasoningOnlyHigh: '仅 High',
  modelReasoningLevelXHigh: 'XHigh',
  modelInputCapability: '输入能力',
  modelInputAutomatic: '自动（模型目录或提供方默认）',
  modelInputText: '仅文本',
  modelInputImages: '文本和图片',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
