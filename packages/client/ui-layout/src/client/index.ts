...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  ...
  interface SlotMap {
    ...
    /** Registration seam retained for the unshipped optional workbench. */
...
/** Owner data for a retained optional workbench registration. */
export interface UtilityOwnerProps { mode: UtilityMode }
