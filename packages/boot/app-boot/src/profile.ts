 ...
 * reused (dangling links are invisible to resolution). Electron packages
 * are resolved through the virtual `app.asar` tree, but filesystem symlinks
 * must target the matching physical `app.asar.unpacked` package when it is
 * present.
