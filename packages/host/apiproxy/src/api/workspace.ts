...
export interface WorkspaceApi {
  ...
  /**
   * Removes one id from the global archive set. The retained workspace account
   * restores the session to its previous grouping position. Idempotent when
   * the id is already visible.
   */
