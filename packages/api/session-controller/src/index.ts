...
export class SessionController extends TypertRemoteService {
  ...
  static Config: z<Config> = z.object({
    ...
    noProjectDirectory: z.string().min(1),
  })
   ...
   * @param config - native-opener and new Session directory policy.
  ...
  constructor(ctx: Context, config: Config, internals: SessionControllerInternals = {}) {
    ...
    this.commands = new SessionCommandController(
      ...
      this.agents,
      process.cwd(),
      config.noProjectDirectory === undefined ? undefined : resolve(homedir(), config.noProjectDirectory),
    )
