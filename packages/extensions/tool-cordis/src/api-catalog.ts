  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Permanently delete one archived, idle ordinary Session.',
        parameters: [{ name: 'request', description: 'archived Session identity to remove.' }],
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Read the Desktop-managed block from the fixed global AGENTS.md.',
        parameters: [],
      ...
      },
      {
        ...
        description: 'Replace only the Desktop-managed global personalization block.',
        parameters: [{ name: 'input', description: 'bounded content and the optimistic revision read by the caller.' }],
