  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Permanently remove an unowned stored session and all its generations.',
        parameters: [{ name: 'id', description: 'the exact stored session to remove after caller authorization.' }],
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Durably checkpoint one live session NOW (all mandatory points call this; tests and carriers may too). The registry cut is snapshotted at this boundary (states are live references), then the session\'s record is replaced in request order, after the log durability barrier. NOT fail-soft — callers on the fail-soft paths contain it.',
