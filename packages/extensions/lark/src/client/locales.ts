export const zh = {
  section: '飞书远程开发',
  title: '飞书远程开发',
  enabled: '插件状态', connected: '连接状态', binding: '当前绑定', queue: '远程队列',
  appId: 'App ID', appSecret: 'App Secret', saveCredentials: '保存凭据',
  enable: '启用', disable: '停用', disabled: '已停用', resume: '恢复队列', clear: '清除数据', repair: '重新配对',
...
export const en = {
  ...
  enabled: 'Plugin status', connected: 'Connection', binding: 'Current binding', queue: 'Remote queue',
  appId: 'App ID', appSecret: 'App Secret', saveCredentials: 'Save credentials',
  enable: 'Enable', disable: 'Disable', disabled: 'Disabled', resume: 'Resume queue', clear: 'Clear data', repair: 'Re-pair',
