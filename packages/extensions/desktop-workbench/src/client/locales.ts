...
export const zh = {
  ...
  terminalTab: '终端 {index}', clearView: '清屏', terminalInterrupt: '⌃C', terminalReady: '终端已就绪', terminalPlaceholder: '输入命令并按回车',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  terminalTab: 'Terminal {index}', clearView: 'Clear', terminalInterrupt: '⌃C', terminalReady: 'Terminal ready', terminalPlaceholder: 'Type a command and press Return',
