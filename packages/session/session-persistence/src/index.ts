...
export abstract class SessionPersistence extends Service {
  ...
  /**
   * Permanently remove an unowned stored session and all its generations.
   * @param id - the exact stored session to remove after caller authorization.
   * @returns whether a stored session was removed; an absent id returns false.
   * @throws {SessionAlreadyOwnedError} while any process holds write ownership.
   */
