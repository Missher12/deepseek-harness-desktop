...
Desktop 0.4.0 从同一份经过测试的 Harness `0.1.1-rc.2` 源码提交构建 Intel macOS DMG 与 Windows x64 Setup，并验证每个由 Desktop 托管的外置大脑组件均已真正加载，不再永久误报需要重启。Windows 目前仍通过安装程序更新；应用内更新暂只支持 Intel macOS。
