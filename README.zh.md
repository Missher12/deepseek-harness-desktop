...
Desktop 0.5.0 从同一份经过测试的 Harness `0.1.1-rc.2` 源码提交构建 Intel macOS DMG 与 Windows x64 Setup。它新增有界的本地文档附件，并将本地智能能力整理为更清晰的“记忆与学习”体验，同时不把尚未完成的浏览器／电脑操控产品打进成品。Windows 目前仍通过安装程序更新；应用内更新暂只支持 Intel macOS。
