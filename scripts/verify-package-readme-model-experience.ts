...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-desktop-shell': { kind: 'none', reason: 'The native shell owns only window presentation, menu navigation and a native preference; it assembles no model request.' },
  ...
  'packages/host/desktop-plugin-runtime': { kind: 'none', reason: 'The Desktop Host package manager registers nothing model-facing.' },
  ...
  'packages/session/usage-insights': { kind: 'none', reason: 'The usage index folds already-logged Session records into a client-facing read model and registers nothing model-facing.' },
  ...
  'packages/extensions/desktop-workbench': { kind: 'none', reason: 'Browser-side Desktop utility surface; registers nothing model-facing.' },
