...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-desktop-control': { kind: 'none', reason: 'Browser-side Desktop control presentation; it registers no prompt, schema, or model context.' },
  'packages/client/ui-settings-personalization': { kind: 'indirect', reason: 'The browser editor persists text consumed by the existing agent-instructions loader; that loader owns the model-visible context.' },
  'packages/client/ui-settings-system-update': { kind: 'none', reason: 'Browser-side updater settings surface; it registers no prompt, schema, or model context.' },
  'packages/client/ui-settings-usage': { kind: 'none', reason: 'Browser-side usage projection; it registers no prompt, schema, or model context.' },
  'packages/control/browser-control': { kind: 'indirect', reason: 'The service seam delegates model schemas and result rendering to dsh-tool-browser-control.' },
  'packages/control/computer-control': { kind: 'indirect', reason: 'The service seam delegates model schemas and result rendering to dsh-tool-computer-control.' },
  'packages/control/desktop-control-host': { kind: 'indirect', reason: 'The Desktop provider delegates every model-facing surface to the Browser and Computer tool consumers.' },
  'packages/control/desktop-control-protocol': { kind: 'none', reason: 'The closed IPC protocol declares transport values and registers no model-facing surface.' },
  'packages/extensions/desktop-workbench': { kind: 'none', reason: 'Desktop workbench UI composition registers no model-facing surface.' },
  'packages/host/desktop-plugin-runtime': { kind: 'none', reason: 'The trusted Desktop plugin launcher registers no prompt, tool schema, or model context.' },
  'packages/session/usage-insights': { kind: 'none', reason: 'The package aggregates already-recorded usage into a client-facing projection and registers no model context.' },
