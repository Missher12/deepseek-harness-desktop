...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  sessionMessengerClient: 'client-side Session Messenger projection — packages/extensions/session-messenger/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  BrainProvider: 'core.md',
  BrainHubSnapshot: 'core.md',
