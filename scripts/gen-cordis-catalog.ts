...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  sessionMessengerClient: 'client-face Session Messenger controller — packages/extensions/session-messenger/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PersonalizationDocumentView: 'settings.md',
  PersonalizationDocumentWrite: 'settings.md',
  ...
  BrainHubSnapshot: 'extensions.md',
  BrainProvider: 'extensions.md',
  DesktopCurrentProfile: 'extensions.md',
  DesktopPnpmHandle: 'extensions.md',
