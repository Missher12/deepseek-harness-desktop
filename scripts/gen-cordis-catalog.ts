...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  desktopPnpm: 'extensions.md',
  desktopProfiles: 'extensions.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  sessionMessengerClient: 'client-side interface-typed messaging service rendered by the Desktop workbench Side Chat — packages/extensions/session-messenger/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  UsageInsightsSnapshot: 'session.md',
  ...
  SaveDocumentAttachment: 'attachment.md',
  StoredDocumentAttachment: 'attachment.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  BrainHubSnapshot: 'pathless settings snapshot is owned by packages/brain/missher-brain/README.md',
  BrainProvider: 'local provider lifecycle is owned by packages/brain/missher-brain/README.md',
  ...
  DesktopCurrentProfile: 'Desktop-only active-profile identity is owned by packages/host/desktop-plugin-runtime/README.md',
  DesktopPnpmHandle: 'Desktop-only package-operation handle is owned by packages/host/desktop-plugin-runtime/README.md',
