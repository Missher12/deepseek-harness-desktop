...
const GENERIC_SKIPS: readonly GenericSkip[] = [
  ...
  // Desktop control composition also enumerates that stable preset id.
  { file: 'apps/desktop/tests/browser-preset.spec.ts', upstream: ['cordis'] },
  { file: 'apps/desktop/tests/computer-preset.spec.ts', upstream: ['cordis'] },
