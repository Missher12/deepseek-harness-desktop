...
- Version 0.1.8 closes the residual generic-CI portability and contract gaps without changing the Desktop feature scope. The unsigned Intel DMG is 163,361,101 bytes with SHA-256 `8759888ec25c65b8cf71bf6c7d1641adee45f7a4d0fa1a9820cf8f2b084f3a68`; `hdiutil verify`, bundle version and `x86_64` checks pass, and the complete isolated packaged smoke passes. Native Windows candidate run `32138876275` passed real per-user install, shortcuts, launch, close, process cleanup, uninstall, and data preservation; its 141,663,191-byte Setup has SHA-256 `176203e630da0d0d8a460c3ac871bd663d642d521c3cbd8c492b905f2287c0ea`, with a separately downloaded 107-byte ASCII checksum that rehashes successfully. Release assets must still come from the latest green run after documentation synchronization.
