...
The authorized upgrade is in progress on `codex/desktop-0.5.8-commander`. The last accepted public Desktop is 0.5.7 at `7f544cd31c43f239c09c3a209ae0d05fe677c710`. The new official source is `fb2c4b9e698e30edb738bca4cf0618587db7d203` (dsh-v0.1.5-rc.2). Content integration uses the verified previously imported `d347e703908d0406b7a7ef80e3a0e594d86b2215`; the older graph merge base is not the previously shipped core. The merge retains both real parents and remains uncommitted while compatibility is verified.
