...
- Version 0.1.5 passed full lint, 267 executed tests across 34 passing test files (one file and one test skipped by design), staging of 62 required files, and the isolated native packaged smoke. The unsigned Intel DMG is 163,335,534 bytes with SHA-256 `a0097c21c909171e7d7158633f639bb8e61beb46a5a38039918f171ba0b74974`; `hdiutil verify` passed, and the app executable plus packaged native modules report `x86_64` while the bundle reports `0.1.5`. Native Windows 0.1.5 packaging and acceptance are deferred; the pre-aligned workflow filenames are not Windows release evidence.
