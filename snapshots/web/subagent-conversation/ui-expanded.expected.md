...
- button "Expand reasoning":
  ...
  - text: Think
  - img
- region "Reasoning content": The user is asking for a one-sentence description of event sourcing. This is a straightforward knowledge question that doesn't require any skill loading or tool calls.
...
- text: 2 turns · 2 steps LLM {{duration}} · Tool call — TTFT avg {{duration}} · {{throughput}} tok/s Cache hit 99% Input 15.6K tok · Output 158 tok Turn est. ¥{{price}} Session est. ¥{{price}} {{pricing tier}}
