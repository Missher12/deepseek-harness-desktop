...
- text: 1 turns · 1 steps LLM {{duration}} · Tool call {{duration}} TTFT avg {{duration}} · — tok/s Cache hit 0% Input 10 tok · Output 10 tok Turn est. ¥{{price}} Session est. ¥{{price}} {{pricing tier}}
