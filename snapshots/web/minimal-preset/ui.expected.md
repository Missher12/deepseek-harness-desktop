...
- text: 1 turns · 2 steps LLM {{duration}} · Tool call {{duration}} TTFT avg {{duration}} · {{throughput}} tok/s Cache hit 0% Input 20 tok · Output 8 tok Turn est. ¥{{price}} Session est. ¥{{price}} {{pricing tier}}
