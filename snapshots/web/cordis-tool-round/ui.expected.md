...
- text: 3 turns · 7 steps LLM {{duration}} · Tool call {{duration}} TTFT avg — · — tok/s Cache hit 77% Input 66.5K tok · Output 321 tok Turn est. ¥{{price}} Session est. ¥{{price}} {{pricing tier}}
