...
- text: 1 turns · 2 steps LLM {{duration}} · Tool call {{duration}} TTFT avg {{duration}} · {{throughput}} tok/s Cache hit 99% Input 15.7K tok · Output 111 tok Turn est. ¥0.0016 Session est. ¥0.0016 {{pricing tier}}
