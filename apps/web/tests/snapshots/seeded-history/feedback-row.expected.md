...
- text: 1 turns · 2 steps LLM {{duration}} · Tool call {{duration}} TTFT avg {{duration}} · {{throughput}} tok/s Cache hit 98% Input 15.8K tok · Output 135 tok Turn est. ¥0.0019 Session est. ¥0.0019 {{pricing tier}}
