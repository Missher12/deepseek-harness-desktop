...
Desktop 0.4.3 keeps the Codex-style prompt ruler and adds two visible control
...
./scripts/windows-desktop-installer-ui-smoke.ps1 `
  -SetupPath apps/desktop/release/DeepSeek-Harness-Setup-0.4.3-win-x64.exe
