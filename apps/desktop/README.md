...
Desktop 0.4.7 keeps the Codex-style prompt ruler and provides two visible control
...
The 0.4.7 browser path gives the newly mounted renderer a bounded twenty-second
...
./scripts/windows-desktop-installer-ui-smoke.ps1 `
  -SetupPath apps/desktop/release/DeepSeek-Harness-Setup-0.4.7-win-x64.exe
