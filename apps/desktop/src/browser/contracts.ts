...
export {
  isDesktopBrowserBounds, isDesktopBrowserRequest, isDesktopBrowserSnapshot, normalizeBrowserTarget,
} from './ui-contracts.ts'
export type { DesktopBrowserBounds, DesktopBrowserRequest, DesktopBrowserSnapshot } from './ui-contracts.ts'
